...
<body>
    ...
    <div class="table-responsive jumbotron">
        <h2>Data pendaftar event makassar</h2>
        <a href="config/excelm.php" class="btn btn-success">Report Excel</a>
        </br>
        </br>
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn-danger" onclick="return confirm('Apakah anda ingin menghapus data?')" href="config/hapusm.php?id=<?php echo $data['id']; ?> "><i class="fa fa-trash" style="padding: 3px; border-radius:30%;"></i></a>
                        </td>
                    </tr>
                </tbody>
            <?php
