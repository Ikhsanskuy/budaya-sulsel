...
<body>
    ...
    <div class="table-responsive jumbotron">
        <h2>Data pendaftar event bunaken</h2>
        <a href="config/excelb.php" class="btn btn-success">Report Excel</a>
        </br>
        </br>
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn-danger" onclick="return confirm('Apakah anda ingin menghapus data?')" href="config/hapusb.php?id=<?php echo $data['id']; ?> "><i class="fa fa-trash" style="padding: 3px; border-radius:30%;"></i></a>
                        </td>
                    </tr>
                </tbody>
            <?php
